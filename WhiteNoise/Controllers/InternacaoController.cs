...
namespace WhiteNoise.Controllers
{
    public class InternacaoController : BaseController
    {
        ...
        private readonly IInternacaoRepository _agendamentoRepository;
        private readonly IMapper _mapper;

        #endregion

        #region Constructors
        public InternacaoController(IMapper mapper, IInternacaoRepository agendamentoRepository)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var agendamentosGridModel = _mapper.Map<List<InternacaoGridModel>>(agendamentos);
        ...
        public async Task<IActionResult> Details(Guid id)
        {
            ...
            var agendamentoFormModel = _mapper.Map<InternacaoFormModel>(agendamento);
        ...
        [HttpPost]
        public async Task<IActionResult> Create(InternacaoFormModel agendamentoFormModel)
        {
            if (ModelState.IsValid)
            {
                var agendamento = _mapper.Map<Internacao>(agendamentoFormModel);
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(Guid id, InternacaoFormModel agendamentoFormModel)
        {
